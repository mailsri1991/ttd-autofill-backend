...
export const FAQ_ENTRIES = [
  {
    ...
    reply:
      "Once you've paid, your license key arrives by email within a couple of minutes. " +
      "To activate it: open the extension popup → go to the \"License\" tab → paste the key → click Activate. " +
      "If it's been more than 10 minutes and you still don't have the email, check your spam folder — and reply here with the email you paid with and we'll resend the key."
  },
  {
    id: "resend_license",
