...
// Built lazily (only when this route actually runs) instead of at import time, so a
// missing/placeholder Razorpay key doesn't crash the function — it just fails this one
// request with a clear message until real keys are set in Vercel's Environment Variables.
